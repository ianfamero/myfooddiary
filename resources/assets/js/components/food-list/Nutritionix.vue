<template>
  <el-dialog title="Nutritionix - Food Database" :visible.sync="isShowModal" :close-on-click-modal="false"
    :show-close="false" :modal-append-to-body="false" top="1em" width="80%" custom-class="fw-modal" :close-on-press-escape="false">
    <el-form>
        <el-row :gutter="20">
          <el-col :xs="15" :sm="10">
            <el-form-item>
              <el-input type="text" v-model="formData.searchQuery"></el-input>
            </el-form-item>
          </el-col>
          <el-col :xs="6" :sm="6">
            <el-form-item>
              <el-button @click="submitForm" type="primary" size="mini" :disabled="isProcessing">Search</el-button>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
